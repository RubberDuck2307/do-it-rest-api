...
import com.example.ToDoAPI.email.email_confirmation.EmailTokenService;
...
import com.example.ToDoAPI.exception.customException.EmailAlreadyTakenException;
import com.example.ToDoAPI.exception.customException.EmailNotVerifiedException;
import com.example.ToDoAPI.jwt.JwtService;
import com.example.ToDoAPI.security.oauth.google.GoogleLoginRequest;
import com.example.ToDoAPI.security.oauth.google.GoogleOAuthService;
...
import com.example.ToDoAPI.user.reset_password.ResetPasswordService;
...
public class AccessService {
    ...
    public ResponseEntity<String> sendResetPasswordEmail(String email) {
        DefaultUserDetails userDetails = userRepo.findByUserEmail(email).orElseThrow(() -> new UsernameNotFoundException("User not found"));
